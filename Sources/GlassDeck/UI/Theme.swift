...
enum Theme {
    ...
    static func accent(_ kind: MetricKind) -> Color {
        Color(hue: kind.hue, saturation: 0.62, brightness: 0.92)
    }

    /// Deeper end of the gauge gradient.
    static func accentShade(_ kind: MetricKind) -> Color {
    ...
    static func gradient(_ kind: MetricKind) -> LinearGradient {
        LinearGradient(
    ...
    static func iconChip(_ kind: MetricKind) -> Color {
